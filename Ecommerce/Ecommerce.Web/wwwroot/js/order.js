$(document).ready(function () {
        ...
        columns: [
            ...
            { data: 'status' },
            {
                data: null, sorting:false,className:"td-actions", render: function (data, type, row) {
                    var button = '<button class="btn btn-info btn-just-icon btn-sm view-order"><i class="carticon-color material-icons">visibility</i></button>';
                    return button;
                }
            }
        ]
    ...
    window.updateTotal = function () {
        ...
        $('#orderTotal').text(total.toLocaleString('en-US', { style: 'currency', currency: 'USD' }));
    }
    fetchData();
